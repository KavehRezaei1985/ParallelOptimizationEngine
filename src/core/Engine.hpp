// src/core/Engine.hpp
//
// Header file declaring the **OptimizationEngine** facade and the full suite of
...
/**
 * @brief Naive sequential strategy: unweighted average of local minima.
 *
 ...
 *
 * Implements fixed-step GD with parallel gradient evaluation via ThreadPool.
